...
class Modmail(commands.Cog):
    ...
    async def inactivity(self, ctx, member: discord.Member):
        ...
        try:
            await member.send(
                "What’s Up!\n\nThis is an automated message from the `WA Management Team`.\n\n*It has recently come to our attention that you have been a little inactive!* 💤 \n\nWe hope you are doing 👌 and staying safe. We would appreciate if you would  There are going to be directions in <#821076577495416864> `[you will see after you verify]` on how to fill out a break request correctly.\n\n*Cheers!*\n`~` **Operations Management**\n*Wumpus Advertisements*"
            )
